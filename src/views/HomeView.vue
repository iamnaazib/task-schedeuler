<template>
  <div class="home">
    <h1>Task Schedeuler</h1>
    <button @click="togglePopup">Add new schdeule</button>
      ...
      <div class="popup-content">
        ...
        <form @submit.prevent="addNewRecipe">
          ...
          <div class="group">
            ...
            <button type="button" @click="addNewStep">Add Task</button>
          </div>

          <button type="submit">Confirm Schedeule</button>
